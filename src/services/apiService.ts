...
import {
  ...
  rouletteRecordRes,
  LoginResponseRecord,
  ThirdPartySignUpResponseRecord, ThirdPartyLoginResponseRecord
} from "~/types/apiTypes";
...
export class ApiService extends BaseApiService implements IBaseApiService {
  ...
  async getRoulette(payload: roulettePayload): Promise<rouletteRes> {
  ...
  async getRouletteRecord(): Promise<rouletteRecordRes> {
