...
SubLayout(
    ...
    .wheel.mb-4
      ...
      .wheel__content(ref="wheelElt")
        ...
        Sector.wheel__sector(
          ...
          :key="idx"
          :text="'₹ '+numeralHelper.asFloat(item.worth, 0)"
  ...
  .luckyWinner
    .luckyWinner__title Lucky winner
    .luckyWinner__textLine(v-for="luckMan in luckyList")
      .luckyUser {{ luckMan.username }}
      .luckyMoney ₹ {{ numeralHelper.asFloat(luckMan.worth, 2) }}
